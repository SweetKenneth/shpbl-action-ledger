...
- The invention was published first as a public behaviour specification
  (`SPEC-agent-action-evidence-ledger`, v1.0),
  <https://github.com/SweetKenneth/shpbl-spec-action-ledger>.
...
- The chain-integrity, redaction and verification layers are **clean-room**: implemented from
  the specification's invariants (§5) and externally testable properties (P1–P12) using this
  package's own published constants and canonical-form rule. No private constant, curve,
  threshold, or internal vocabulary was consulted or reproduced, and verification never
